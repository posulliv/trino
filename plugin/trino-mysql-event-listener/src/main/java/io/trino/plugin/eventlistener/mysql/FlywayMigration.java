...
public class FlywayMigration
{
    ...
    private static String getLocation(String configDbUrl)
    {
        ...
        throw new IllegalArgumentException(format("Invalid JDBC URL: %s. Only MySQL is supported.", configDbUrl));
    }

    public static void migrate(MysqlEventListenerConfig config)
    {
